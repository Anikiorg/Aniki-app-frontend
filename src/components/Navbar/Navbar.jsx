...
function Navbar() {
  ...
  return (
<div className="navbar text-5xl bg-base-100 shadow-xl">
  <div className="flex-none">
  </div>
  <div className="flex-1">
<Link to="/" className="flex hover:text-orange-600">
    ...
    <div className="dropdown dropdown-end">
      <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
        <div className="w-34 rounded-full">
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-user"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
        </div>
      </div>
